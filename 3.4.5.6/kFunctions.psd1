...
GUID = 'c55f2edd-8b9d-3323-945c-87ed1ccfc66f'
...
FunctionsToExport = 'Get-K8sAPIInfo'  , 'Get-NameSpace' , 'Get-Pod'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'API', 'MicroK8s', 'K3s', 'K8s', 'Kubernetes', 'Namespace' , 'Pod'
